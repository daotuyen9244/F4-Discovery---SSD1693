...
void write_command(unsigned char c)
{
	...
	HAL_GPIO_WritePin(GPIOE,GPIO_PIN_10,(GPIO_PinState)c&0x80);
	HAL_GPIO_WritePin(GPIOE,GPIO_PIN_9,(GPIO_PinState)c&0x40);
	HAL_GPIO_WritePin(GPIOE,GPIO_PIN_8,(GPIO_PinState)c&0x20);
	HAL_GPIO_WritePin(GPIOE,GPIO_PIN_7,(GPIO_PinState)c&0x10);
	HAL_GPIO_WritePin(GPIOD,GPIO_PIN_1,(GPIO_PinState)c&0x08);
	HAL_GPIO_WritePin(GPIOD,GPIO_PIN_0,(GPIO_PinState)c&0x04);
	HAL_GPIO_WritePin(GPIOD,GPIO_PIN_15,(GPIO_PinState)c&0x02);
	HAL_GPIO_WritePin(GPIOD,GPIO_PIN_14,(GPIO_PinState)c&0x01);
...
void Write_Data_byte(unsigned char DH,unsigned char DL)
{
	...
	HAL_GPIO_WritePin(GPIOD,GPIO_PIN_10,(GPIO_PinState)DH&0x80);
	HAL_GPIO_WritePin(GPIOD,GPIO_PIN_9,(GPIO_PinState)DH&0x40);
	HAL_GPIO_WritePin(GPIOD,GPIO_PIN_8,(GPIO_PinState)DH&0x20);
	HAL_GPIO_WritePin(GPIOE,GPIO_PIN_15,(GPIO_PinState)DH&0x10);
	HAL_GPIO_WritePin(GPIOE,GPIO_PIN_14,(GPIO_PinState)DH&0x08);
	HAL_GPIO_WritePin(GPIOE,GPIO_PIN_13,(GPIO_PinState)DH&0x04);
	HAL_GPIO_WritePin(GPIOE,GPIO_PIN_12,(GPIO_PinState)DH&0x02);
	HAL_GPIO_WritePin(GPIOE,GPIO_PIN_11,(GPIO_PinState)DH&0x01);
	
	HAL_GPIO_WritePin(GPIOE,GPIO_PIN_10,(GPIO_PinState)DL&0x80);
	HAL_GPIO_WritePin(GPIOE,GPIO_PIN_9,(GPIO_PinState)DL&0x40);
	HAL_GPIO_WritePin(GPIOE,GPIO_PIN_8,(GPIO_PinState)DL&0x20);
	HAL_GPIO_WritePin(GPIOE,GPIO_PIN_7,(GPIO_PinState)DL&0x10);
	HAL_GPIO_WritePin(GPIOD,GPIO_PIN_1,(GPIO_PinState)DL&0x08);
	HAL_GPIO_WritePin(GPIOD,GPIO_PIN_0,(GPIO_PinState)DL&0x04);
	HAL_GPIO_WritePin(GPIOD,GPIO_PIN_15,(GPIO_PinState)DL&0x02);
	HAL_GPIO_WritePin(GPIOD,GPIO_PIN_14,(GPIO_PinState)DL&0x01);
